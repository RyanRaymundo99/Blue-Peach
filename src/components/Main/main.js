export const Main = () => {
    return (
      <section>
        <div className="relative px-4 pt-16 mx-auto lg:py-32 md:px-8 xl:px-20 sm:max-w-xl md:max-w-full bg-white">
          <div className="max-w-xl mx-auto lg:max-w-screen-xl">
            <div className="mb-16 lg:max-w-lg lg:mb-0">
              <div className="max-w-xl mb-6">
                <div>
                  <p className="inline-block px-3 py-px mb-4 text-lg font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-teal-400/40">
                    Atualizado
                  </p>
                </div>
                ...
                <p className="text-2xl text-gray-700 md:text-xl">
                  Simples, Rápido e Prático, basta criar seu currículo com informações chave, depois disso entraremos em contato caso a empresa tenha interesse em te conhecer melhor.
                </p>
              </div>
